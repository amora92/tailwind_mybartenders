...
const Service_Daisy = () => {
  return (
    <div>
      <section className='bg-white dark:bg-gray-10'>
        <div className='py-8 px-4 mx-auto pt-10 mt-20 mb-20 max-w-screen-xl sm:py-16 lg:px-6'>
          <div className='max-w-screen-md mb-8 lg:mb-16'>
            ...
            <p className='text-black sm:text-xl dark:text-black'>
              ...
              where hospitality, innovation, and guest satisfaction come
          ...
          <div className='space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0'>
            ...
            <div>
              ...
              <p className='text-black dark:text-black'>
                ...
                ensuring a delightful experience through thoughtful design and
                collaboration.
              </p>
            </div>
            <div>
