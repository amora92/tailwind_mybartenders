...
const TermsAndConditions = () => {
  return (
    <>
      <Head>
        <title>Terms and Conditions | Mybartenders.co.uk</title>
        <meta
          name='description'
      ...
      <div className='bg-gradient-to-b from-white via-pink-50/30 to-white'>
        <div className='container mx-auto px-4 py-16 max-w-4xl'>
          ...
          <p className='text-lg mb-8 text-gray-700'>
            ...
            MyBartenders and our clients for mobile bartending services in the
            UK. Specific arrangements can be discussed and agreed upon during
            the booking process.
          </p>
          ...
          <section className='mb-8'>
            ...
            <div className='space-y-4 text-gray-700'>
              <p>
                • We respect your privacy and handle your data in accordance
                with our{' '}
                <Link
                  href='/privacy-policy'
