  ...
  return (
    <div className='container mx-auto px-4 py-8'>
      ...
      <p className='text-lg mb-4'>
        This Privacy Policy explains how Mybartenders.co.uk collects, uses, and
        protects the personal data of users visiting our website or using our
      ...
      <section className='mb-6'>
        ...
        <p className='mb-4'>
          ...
          our services. However, we do not use cookies to collect personal data.
        </p>
        <p className='mb-4'>
          You can control cookie settings in your browser. Please note that
          disabling cookies may impact your ability to use some features of the
          website.
        </p>
      </section>
      ...
      <section className='mb-6'>
        ...
        <p className='mb-4'>
          ...
          with third-party services, except where required by law. If you choose
          to interact with third-party services (such as social media platforms
          or payment processors), please review their privacy policies.
        </p>
      </section>
      ...
      <section className='mb-6'>
        ...
        <ul className='list-inside list-disc mb-4'>
          ...
          <li>
            Request the restriction of processing your personal data in certain
            circumstances.
          </li>
        </ul>
        <p className='mb-4'>
          If you would like to exercise any of these rights or have any concerns
          about your personal data, please contact us at{' '}
          <Link
      ...
      <section className='mb-6'>
        ...
        <p className='mb-4'>
          We take appropriate measures to protect the personal data you provide
          through our website. However, no method of electronic transmission or
      ...
      <section className='mb-6'>
        ...
        <p className='mb-4'>
          ...
          be posted on this page with an updated date at the top. We encourage
      ...
      <section className='mb-6'>
        ...
        <p className='mb-4'>
          This Privacy Policy is governed by the laws of the United Kingdom. Any
