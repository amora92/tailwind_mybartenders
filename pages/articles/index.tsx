...
const Articles = () => {
  ...
  return (
    <>
      <Head>
        <title>Articles | Latest Stories & Insights</title>
        <meta
          name='description'
          content='Discover the latest stories, insights, and tutorials from our community. Stay updated with our featured and most recent articles.'
        />
        ...
        <main className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 mt-20'>
          ...
          <div className='mb-8 flex flex-col sm:flex-row gap-4 items-center'>
            <input
              ...
              className='w-full sm:w-64 px-4 py-2 border rounded-lg focus:ring-2 focus:ring-gold-500 focus:border-transparent'
            />
                ...
                <div className='group relative rounded-2xl overflow-hidden bg-white shadow-xl hover:shadow-2xl transition-all duration-300'>
                  <div className='grid md:grid-cols-2'>
                    ...
                    <div className='p-8 md:p-12 flex flex-col justify-center'>
                      ...
                      <h2 className='text-3xl font-bold text-gray-900 mb-4 group-hover:text-gold-600'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            {regularArticles.map(article => (
              <Link
                ...
                className='group'
              >
                <article className='bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col'>
                  ...
                  <div className='p-6 flex flex-col flex-1'>
                    <h2 className='text-xl font-bold text-gray-900 mb-3 group-hover:text-gold-600'>
                      {article.title}
                    </h2>
